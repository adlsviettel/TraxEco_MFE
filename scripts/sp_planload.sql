Text                                                                                                                                                                                                                                                           
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CREATE proc [dbo].[InlineFGsWHPlanLoad_Cust]  -- exec InlineFGsWHPlanLoad_Cust '20251016','Puma'
...
BEGIN
	...
	WHERE a.Comment2 IN ('New','Rev') AND a.SchExFactory >= DATEADD(DAY,-30,GETDATE()) AND LEFT(a.InvNo,1) = 'V'
	...
	----select * from #TempHx where PONo like '%124898891' select * from #Temp select * from #TempHy drop table #Temp
