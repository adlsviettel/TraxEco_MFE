...
filepath = r"d:\TSI\TestClaudeCode\TraxEco\src\apps\TCC_TEMPLATE\pages\RequestorViewPage.tsx"
...
old_def = "export default function RequestorViewPage() {\n  const { t } = useTranslation();"
new_def = """export default function RequestorViewPage() {
  const { t } = useTranslation();
...
print("RequestorViewPage updated!")
