...
GO
ALTER proc [dbo].[InlineFGsWHPlanLoad_Cust_v2]  -- exec InlineFGsWHPlanLoad_Cust '20251016','Puma'
...
SELECT b.PlanRefNo, b.PONo, b.BuyerItem, b.ModelNo, b.CustSize, b.ManuSize, b.GPSSize, b.CTNNo, b.CTNSeriNo, b.PackedQty, b.SysCreateDate, b.CreatedBy, b.Factory, b.RecNo, b.GrssW, b.NetW, b.InsPickCTN, b.InsGetCTN, b.CTNL, b.CTNW, b.CTNH, b.OrderNo, b.NumberIn
INTO #Temp_PKList
FROM #tempTu a
LEFT JOIN dbo.InlineFGsWHPkList b WITH (NOLOCK) ON RIGHT(a.PONo,9) = b.PONo_9
WHERE b.CTNL IS NOT NULL
UNION ALL
SELECT P1.PlanRefNo, P1.PONo, P1.BuyerItem, P1.ModelNo, P1.CustSize, P1.ManuSize, P1.GPSSize, P1.CTNNo, P1.CTNSeriNo, P1.PackedQty, P1.SysCreateDate, P1.CreatedBy, P1.Factory, P1.RecNo, P2.GrssW, P2.NetW, P1.InsPickCTN, P1.InsGetCTN, P2.CTNL, P2.CTNW, P2.CTNH, P1.OrderNo, P1.NumberIn
FROM
(
SELECT b.*
FROM #tempTu a
