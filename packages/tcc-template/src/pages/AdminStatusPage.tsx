  ...
  return (
    <Box sx={{ height: '100%', minHeight: 0, display: 'flex', flexDirection: 'column', gap: 1.5, overflow: 'hidden' }}>
      ...
      {isMobile ? (
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 1.5, mb: 1, px: 3, py: 2, bgcolor: 'background.paper', borderBottom: '1px solid', borderColor: 'divider', flexShrink: 0 }}>
            ...
            <DatePicker format="dd/MM/yyyy"
              ...
              slotProps={{
                ...
                textField: {
                  ...
                  size: 'small',
                  sx: {
                    '& .MuiOutlinedInput-root': { borderRadius: '8px', height: 40, fontSize: 13, bgcolor: 'background.paper' }
                  }
                }
              }}
            />
